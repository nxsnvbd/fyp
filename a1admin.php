...
&nbsp;
<h1 align="center"><strong>Youth Orator Club</strong></h1>

<p align="center"><img src="yoc.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Youth Orator Club' ";
		...
		<td>
		<form action="a1admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "a1admin.php"';
	echo '</script>';
}
