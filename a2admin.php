...
&nbsp;
<h1 align="center"><strong>The Magister Club</strong></h1>

<p align="center"><img src="tmc.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='The Magister Club' ";
		...
		<td>
		<form action="a2admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "a2admin.php"';
	echo '</script>';
}
