...
<title>English Society Club</title>
...
&nbsp;
<h1 align="center"><strong>English Society Club</strong></h1>

<p align="center"><img src="esoc.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='English Society Club' ";
		...
		<td>
		<form action="a4admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "a4admin.php"';
	echo '</script>';
}
