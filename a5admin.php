...
&nbsp;
<h1 align="center"><strong>Accounting Club</strong></h1>

<p align="center"><img src="acc.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Accounting Club' ";
		...
		<td>
		<form action="a5admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "a5admin.php"';
	echo '</script>';
}
