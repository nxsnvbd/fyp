...
<title>Society of Corporate Administration</title>
...
&nbsp;
<h1 align="center"><strong>Society of Corporate Administration</strong></h1>

<p align="center"><img src="sca.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Society of Corporate Administration' ";
		...
		<td>
		<form action="a6admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "a6admin.php"';
	echo '</script>';
}
