...
<title>Smart Caliph Society Club</title>
...
&nbsp;
<h1 align="center"><strong>Smart Caliph Society Club</strong></h1>

<p align="center"><img src="caliph.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Smart Caliph Society Club' ";
		...
		<td>
		<form action="h1admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "h1admin.php"';
	echo '</script>';
}
