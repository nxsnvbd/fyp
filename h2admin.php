...
&nbsp;
<h1 align="center"><strong>Usahawan</strong></h1>

<p align="center"><img src="usahawan2.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Usahawan' ";
		...
		<td>
		<form action="h2admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "h2admin.php"';
	echo '</script>';
}
