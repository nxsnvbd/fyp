...
&nbsp;
<h1 align="center"><strong>The Vocalism</strong></h1>

<p align="center"><img src="vocalism.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='The Vocalism' ";
		...
		<td>
		<form action="h3admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "h3admin.php"';
	echo '</script>';
}
