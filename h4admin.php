...
&nbsp;
<h1 align="center"><strong>Akasia</strong></h1>

<p align="center"><img src="akasia.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Akasia' ";
		...
		<td>
		<form action="h4admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "h4admin.php"';
	echo '</script>';
}
