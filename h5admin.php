...
&nbsp;
<h1 align="center"><strong>Anak Teater</strong></h1>

<p align="center"><img src="anakteater.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Anak Teater' ";
		...
		<td>
		<form action="h5admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "h5admin.php"';
	echo '</script>';
}
