...
&nbsp;
<h1 align="center"><strong>Angakatan Mahasiswa Anti Rasuah</strong></h1>

<p align="center"><img src="amar.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Angakatan Mahasiswa Anti Rasuah' ";
		...
		<td>
		<form action="h6admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "h6admin.php"';
	echo '</script>';
}
