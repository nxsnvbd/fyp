...
&nbsp;
<h1 align="center"><strong>Fasilitator</strong></h1>

<p align="center"><img src="fasi.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Fasilitator' ";
		...
		<td>
		<form action="h7admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "h7admin.php"';
	echo '</script>';
}
