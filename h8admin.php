...
<title>Creative Media Club</title>
...
&nbsp;
<h1 align="center"><strong>Creative Media Club</strong></h1>

<p align="center"><img src="cmc.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Creative Media Club' ";
		...
		<td>
		<form action="h8admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "h8admin.php"';
	echo '</script>';
}
