...
<title>Sekretriat Rakan Muda</title>
...
&nbsp;
<h1 align="center"><strong>Sekretriat Rakan Muda</strong></h1>

<p align="center"><img src="srm.jpg" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Sekretriat Rakan Muda' ";
		...
		<td>
		<form action="h9admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "h9admin.php"';
	echo '</script>';
}
