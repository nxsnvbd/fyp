...
<title>Extreme Youth Club</title>
...
&nbsp;
<h1 align="center"><strong>Extreme Youth Club</strong></h1>

<p align="center"><img src="eyc.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Extreme Youth Club' ";
		...
		<td>
		<form action="s10admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s10admin.php"';
	echo '</script>';
}
