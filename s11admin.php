...
&nbsp;
<h1 align="center"><strong>UPTM Futsal Club</strong></h1>

<p align="center"><img src="futsal.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='UPTM Futsal Club' ";
		...
		<td>
		<form action="s11admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s11admin.php"';
	echo '</script>';
}
