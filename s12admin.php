...
&nbsp;
<h1 align="center"><strong>Pregerine Archers</strong></h1>

<p align="center"><img src="archers.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Pregerine Archers' ";
		...
		<td>
		<form action="s12admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s12admin.php"';
	echo '</script>';
}
