...
<title>Eagles Paintball Club</title>
...
&nbsp;
<h1 align="center"><strong>Eagles Paintball Club</strong></h1>

<p align="center"><img src="paintball.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Eagles Paintball Club' ";
		...
		<td>
		<form action="s13admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s13admin.php"';
	echo '</script>';
}
