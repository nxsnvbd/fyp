...
&nbsp;
<h1 align="center"><strong>Eagles Basketball Club</strong></h1>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Eagles Basketball Club' ";
		...
		<td>
		<form action="s14admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s14admin.php"';
	echo '</script>';
}
