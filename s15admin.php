...
<title>Eagles Hockey Club</title>
...
&nbsp;
<h1 align="center"><strong>Eagles Hockey Club</strong></h1>

<p align="center"><img src="hockey.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Eagles Hockey Club' ";
		...
		<td>
		<form action="s15admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s15admin.php"';
	echo '</script>';
}
