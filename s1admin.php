...
<title>Panthera Netball Club</title>
...
&nbsp;
<h1 align="center"><strong>Panthera Netball Club</strong></h1>

<p align="center"><img src="netball.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Panthera Netball Club' ";
		...
		<td>
		<form action="s1admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s1admin.php"';
	echo '</script>';
}
