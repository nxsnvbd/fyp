...
<title>Club Chess Kasparov</title>
...
&nbsp;
<h1 align="center"><strong>Club Chess Kasparov</strong></h1>

<p align="center"><img src="chess.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Club Chess Kasparov' ";
		...
		<td>
		<form action="s2admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s2admin.php"';
	echo '</script>';
}
