...
&nbsp;
<h1 align="center"><strong>Table Tennis Club</strong></h1>

<p align="center"><img src="tennis.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Table Tennis Club' ";
		...
		<td>
		<form action="s3admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s3admin.php"';
	echo '</script>';
}
