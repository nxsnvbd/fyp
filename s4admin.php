...
&nbsp;
<h1 align="center"><strong>Kelab Silat Seni Gayung UPTM</strong></h1>

<p align="center"><img src="silat.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Kelab Silat Seni Gayung' ";
		...
		<td>
		<form action="s4admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s4admin.php"';
	echo '</script>';
}
