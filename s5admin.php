...
&nbsp;
<h1 align="center"><strong>Club Taekwando</strong></h1>

<p align="center"><img src="taekwando.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Taekwando' ";
		...
		<td>
		<form action="s5admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s5admin.php"';
	echo '</script>';
}
