...
<title>White Eagles Volleyball Club</title>
...
&nbsp;
<h1 align="center"><strong>White Eagles Volleyball Club</strong></h1>

<p align="center"><img src="volley.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='White Eagles Volleyball Club' ";
		...
		<td>
		<form action="s6admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s6admin.php"';
	echo '</script>';
}
