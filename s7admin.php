...
<title>Panthers Rugby Club</title>
...
&nbsp;
<h1 align="center"><strong>Panthers Rugby Club</strong></h1>

<p align="center"><img src="rugby.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Panthers Rugby Club' ";
		...
		<td>
		<form action="s7admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s7admin.php"';
	echo '</script>';
}
