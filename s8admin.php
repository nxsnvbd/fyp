...
<title>Scorpio Lethic(Track and Field)</title>
...
&nbsp;
<h1 align="center"><strong>Scorpio Lethic(Track and Field)</strong></h1>

<p align="center"><img src="track.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='Scorpio Lethic(Track and Field)' ";
		...
		<td>
		<form action="s8admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s8admin.php"';
	echo '</script>';
}
