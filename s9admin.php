...
&nbsp;
<h1 align="center"><strong>UPTM Eagles FC</strong></h1>

<p align="center"><img src="football.png" width="20%" ></p>
...
<div>
	...
	<table border="1" align="center">
		...
		<?php
		$query= "SELECT * FROM registration WHERE status='pending' and clubs='UPTM Eagles FC' ";
		...
		<td>
		<form action="s9admin.php" method="POST">
...
if (isset($_POST['approve'])){
	...
	echo 'window.location.href = "s9admin.php"';
	echo '</script>';
}
